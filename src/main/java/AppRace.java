...
//        TrackSegmentOLD segment2 = new TrackSegmentOLD(2,  60, 6);
//        TrackSegmentOLD segment3 = new TrackSegmentOLD(3,  100, 6);
//        TrackSegmentOLD segment4 = new TrackSegmentOLD(4,  60, 6);
//        TrackSegmentOLD segment5 = new TrackSegmentOLD(5,  100, 3);
//
//        List<TrackSegmentOLD> spanishGPsegments = new LinkedList();
//        spanishGPsegments.add(segment1);
//        spanishGPsegments.add(segment2);
//        spanishGPsegments.add(segment3);
